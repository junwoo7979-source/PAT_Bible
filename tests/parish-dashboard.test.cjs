...
assert.match(rendered, /1블레싱/);
assert.match(rendered, /2블레싱/);
assert.match(rendered, /3블레싱/);
assert.match(rendered, /2블레싱[\s\S]*내 교구/);
assert.match(rendered, /2블레싱[\s\S]*49\/72명/);
